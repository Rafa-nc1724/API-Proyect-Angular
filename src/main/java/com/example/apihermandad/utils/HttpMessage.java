...
public class HttpMessage {
    ...
    public static final String NOT_FOUND_IMG = "Imágen no encontrada";
    public static final String TR_SOLAP = "Tramo solapado";
    public static final String ERROR_DAYS = "La fecha de entrada no puede ser anterior a la de salida";
}
